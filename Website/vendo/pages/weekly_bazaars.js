...
export default function dashboard({ WeeklyBazaars }) {
  ...
  const [_vendorTypeFavourables, setvendorTypeFavourable] = React.useState([
    0, 0, 0, 0, 0, 0,
  ]);
        ...
        <div className="add-vending-zones">
          <Accordion defaultActiveKey="1">
            <Accordion.Item eventKey="0">
              ...
              <Accordion.Body>
                <CommonInput
                  placeholderText="Enter bazaar name"
                  onChange={(e) => {
                    setbazaarName(e.target.value);
                  }}
                />
                <CommonInput
                  placeholderText="Enter date of the event"
                  onChange={(e) => {
                ...
                />
                <CommonInput
                  placeholderText="Enter maximum capacity of vendors"
                  onChange={(e) => {
                ...
                <Highlighter
                  Text="Select favourable vendor categories"
                  fontSize="1.2rem"
                />
                <Form>
                  {[
                ...
                <Button style={{ marginTop: "20px" }} onClick={uploadData}>
                  Submit
                </Button>
              </Accordion.Body>
            </Accordion.Item>
        ...
        <div className="vendor-zone-list">
          <ul>
            {WeeklyBazaarList.map((bazaar) => {
              let url = "/weekly_bazaar/" + bazaar.bazzarId;
              return (
                <li>
                  <Card key={bazaar.bazzarId}>
                    <Card.Body>
                      <Card.Title>
                        <div className="pending-application-section-title">
                          <a href={url}>Weekly bazaar id - {bazaar.bazzarId}</a>
                        </div>
                        <div className="pending-application-section-title">
                          {bazaar.bazzarName}
                          <br />
